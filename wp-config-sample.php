...
define( 'FTP_HOST', '2.153.98.254' ); // Cambia 'localhost' por tu dirección IP
define( 'FTP_USER', 'pipa' ); // Cambia tu_usuario_ftp por tu nombre de usuario FTP
define( 'FTP_PASS', '771314' ); // Cambia tu_contraseña_ftp por tu contraseña FTP
