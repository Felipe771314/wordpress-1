...
/* harmony import */var e=n(66886),t=n(69307),r=n(55609),s=n(92694),o=n(65736),i=n(9240),__=o.__,a=function(n){var o=n.isDisabled,a=void 0===o||o,u=(0,t.useState)("add"),l=(0,e/* ["default"] */.Z)(u,2),c=l[0],d=l[1],m=(0,t.useState)(!1),f=(0,e/* ["default"] */.Z)(m,2),p=f[0],v=f[1],g=(0,t.useState)([]),h=(0,e/* ["default"] */.Z)(g,2),b=h[0],y=h[1],w=(0,t.useState)(""),E=(0,e/* ["default"] */.Z)(w,2),Z=E[0],_=E[1],S=(0,t.useState)(a),k=(0,e/* ["default"] */.Z)(S,2),C=k[0],x=k[1],A=function(e){e&&window.location.reload(),v(!1)},N=function(e){x(!(e.detail&&e.detail.enable))};(0,t.useEffect)((function(){return window.addEventListener("enableDisableCourseSelectionToggle",N),function(){window.removeEventListener("enableDisableCourseSelectionToggle",N)}}),[]);var O=(0,t.createElement)(i/* ["default"] */.Z,{action:c,onClose:A,students:b,studentDisplayName:Z}),P=(0,s.applyFilters)("senseiStudentBulkActionModal",O,c,A,b,Z);return(0,t.createElement)(t.Fragment,null,(0,t.createElement)(r.Button,{className:"button button-primary sensei-student-bulk-actions__button",disabled:C,id:"sensei-bulk-learner-actions-modal-toggle",onClick:function(){var e=document.getElementById("bulk-action-selector-top"),t=document.getElementById("bulk-action-user-ids");if(e&&function(e){switch(e){case"enrol_restore_enrolment":d("add");break;case"remove_enrolment":d("remove");break;case"remove_progress":d("reset-progress");break;default:d(e)}}(e.value),t)try{var n=JSON.parse(t.value);y(n),1===n.length&&_(document.querySelector("input.sensei_user_select_id:checked").closest("tr").querySelector(".student-action-menu").getAttribute("data-user-display-name"))}catch(e){}v(!0)}},__("Select Action","sensei-lms")),(0,t.createElement)("input",{type:"hidden",id:"bulk-action-user-ids"}),p&&P)};
